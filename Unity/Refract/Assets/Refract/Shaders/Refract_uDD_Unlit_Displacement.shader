Shader "Refract/uDD_Unlit_Displacement"
{
    ...
    float3 bary : SV_DomainLocation)
{
    ...
    // Luminance rather than length to ignore alpha
    float disp = Luminance(_DispTex.SampleLevel(sampler_DispTex, o.f2TexCoord, 0)) * _DispFactor;
